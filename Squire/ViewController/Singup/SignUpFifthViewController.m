...
@interface SignUpFifthViewController ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
@property (weak, nonatomic) IBOutlet UILabel *Q10;
@property (weak, nonatomic) IBOutlet UILabel *Q11;
@property (weak, nonatomic) IBOutlet UILabel *Q12;
@property (weak, nonatomic) IBOutlet UILabel *Q13;
@property (weak, nonatomic) IBOutlet UILabel *Q14;
@property (weak, nonatomic) IBOutlet UILabel *Q15;
...
@implementation SignUpFifthViewController
...
//    _pickerView.backgroundColor = [UIColor colorWithRed:0.13 green:0.55 blue:0.68 alpha:1.00];
    ...
    _Q10.text = NSLocalizedString(@"Q10", @"");
    _Q11.text = NSLocalizedString(@"Q11", @"");
    _Q12.text = NSLocalizedString(@"Q12", @"");
    _Q13.text = NSLocalizedString(@"Q13", @"");
    _Q14.text = NSLocalizedString(@"Q14", @"");
    _Q15.text = NSLocalizedString(@"Q15", @"");
